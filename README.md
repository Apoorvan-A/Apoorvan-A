...
<p align="center">
  ...
  <a href="https://drive.google.com/file/d/1idEL1jdoJ53lm5AjkpSOl1fZPIRaD2CK/view"><img src="https://img.shields.io/badge/Resume-View-6366F1?style=for-the-badge&logo=readdotcv&logoColor=white"/></a>
</p>
...
<p align="center"><sub>Ingestion decoupled from scoring via <b>Redis Streams</b> and an async consumer-group worker pool over <b>FastAPI</b> and <b>PostgreSQL</b>. Feature lookups moved to an O(1) Redis store (atomic Lua) for a <b>4.7&times; throughput</b> gain. &rarr; <a href="https://github.com/Apoorvan-A/Fraud-Detection">See the code</a></sub></p>
...
#### [Real-Time Fraud Detection](https://github.com/Apoorvan-A/Fraud-Detection)
